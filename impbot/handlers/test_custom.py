...
class CustomCommandHandlerTest(tests_util.DataHandlerTest):
    ...
    def testOnlyModsCanAdd(self, mock_peek, mock_fire):
        self.assert_error("!addcom !blame It's always Ms. Boogie's fault.", "You can't do that.")

    def testPlain(self, mock_peek, mock_fire):
        self.assert_no_trigger('!blame')
        self.assert_response(
            "!addcom !blame It's always Ms. Boogie's fault.", 'Added !blame.', self.mod)
        ...
        self.assert_response('!blame', "It's always Ms. Boogie's fault.", self.mod)
        # It should be case-insensitive.
        self.assert_response('!BlAmE', "It's always Ms. Boogie's fault.")
        # Editing should work.
        self.assert_response(
            "!editcom !blame It's still Ms. Boogie's fault.", 'Edited !blame.', self.mod)
    ...
    def testWithCount(self, mock_peek, mock_fire):
        ...
        self.assert_response('!addcom !sheep (count) sheep jumped the fence.', 'Added !sheep.',
                             self.mod)
        ...
        self.assert_response('!resetcount !sheep', 'Reset !sheep counter to 0.', self.mod)
        self.assert_response('!sheep', '1 sheep jumped the fence.')
        self.assert_response('!resetcount !sheep 16', 'Reset !sheep counter to 16.', self.mod)
    ...
    def testAliases(self, mock_peek, mock_fire):
        ...
        self.assert_response('!aliascom !meta !test', 'Added !meta as an alias to !ping.', self.mod)
        self.assert_response('!meta', 'Pong!')
        # Editing the alias should edit the command.
        self.assert_response('!editcom !test Edited pong!', 'Edited !test (alias to !ping).',
                             self.mod)
        ...
        self.assert_response('!delcom !test', 'Deleted !test. (It was an alias to !ping.)',
                             self.mod)
