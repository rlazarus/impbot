...
class DiscordLogger:
    def __init__(self, channel_id: int):
        # TODO: Check that we already have access to the guild and the channel,
        #  and prompt with the invite link if we don't.
        self.channel_id = channel_id

    def embed(self, color: int, text: str,
    ...
    def _post_message(self, **json: Any) -> None:
        response = requests.post(
            f"https://discord.com/api/v6/channels/{self.channel_id}/messages",
            json=json,
            headers={
