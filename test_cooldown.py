...
class CooldownTest(unittest.TestCase):
    ...
    def testCompound(self):
        ...
        self.assertTrue(cds.peek(bot.User('alice')))
        self.assertTrue(cds.peek(bot.User('bob')))
        self.assertTrue(cds.fire(bot.User('alice')))
        self.assertFalse(cds.peek(bot.User('alice')))
        self.assertFalse(cds.peek(bot.User('bob')))
        self.time.tick(59)
        self.assertFalse(cds.peek(bot.User('alice')))
        self.assertFalse(cds.peek(bot.User('bob')))
        self.assertFalse(cds.fire(bot.User('alice')))
        self.assertFalse(cds.peek(bot.User('alice')))
        self.assertFalse(cds.peek(bot.User('bob')))
        self.time.tick(1)
        self.assertFalse(cds.peek(bot.User('alice')))
        ...
        self.assertFalse(cds.peek(bot.User('alice')))
        self.assertTrue(cds.peek(bot.User('bob')))
        self.assertTrue(cds.fire(bot.User('bob')))
        self.assertFalse(cds.peek(bot.User('alice')))
        self.assertFalse(cds.peek(bot.User('bob')))
        self.time.tick(4 * 60)
        self.assertTrue(cds.peek(bot.User('alice')))
